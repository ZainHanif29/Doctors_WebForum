...
namespace Doctors_WebForum.Controllers
{
    public class DoctorRegsController : Controller
    {
        ...
        public DoctorRegsController(Doctors_WebForumContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["DExperience"] = new SelectList(_context.Experiences, "EId", "EName");
            ViewData["DPrivacy"] = new SelectList(_context.Privacies, "PId", "PName");
            ViewData["DQualification"] = new SelectList(_context.Qualifications, "QId", "QName");
            ViewData["DSpecialization"] = new SelectList(_context.Specializations, "SId", "SName");
            return View();
        }
