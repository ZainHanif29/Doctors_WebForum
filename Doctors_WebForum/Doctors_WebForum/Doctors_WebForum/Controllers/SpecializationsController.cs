...
namespace Doctors_WebForum.Controllers
{
    public class SpecializationsController : Controller
    {
        ...
        public SpecializationsController(Doctors_WebForumContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Specializations != null ? 
                          ...
                          Problem("Entity set 'Doctors_WebForumContext.Specializations'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Doctors_WebForumContext.Specializations'  is null.");
            }
            var specialization = await _context.Specializations.FindAsync(id);
            if (specialization != null)
            {
